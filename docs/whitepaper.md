...
**Botnet.** A chain built without burns has denominator 1 and very large scores. The honest network's accumulated burn weight produces far lower cumulative scores; every node independently prefers the honest chain.
